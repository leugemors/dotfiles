...
##   |_|  |_|\_\_|
##
##   My personal Qtile configuration file.
##
#############################################################################
...
groups.append(ScratchPad("scratchpad", [
    ...
    DropDown("terminal3", myTerminal, opacity = 0.9, height = 0.8, width = 0.75, x = 0.125, y = 0.01, on_focus_lost_hide = True),
    DropDown("terminal4", myTerminal, opacity = 0.9, height = 0.8, width = 0.75, x = 0.125, y = 0.01, on_focus_lost_hide = True),
...
def autostart():
    ...
    subprocess.call([autostartscript]) # Popen ?
